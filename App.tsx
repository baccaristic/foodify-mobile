...
import RestaurantChangeOverlayContainer from '~/components/RestaurantChangeOverlayContainer';
...
import CashPointsScreen from '~/screens/Profile/CashPointsScreen';
...
const RootNavigator = () => {
  ...
  return (
    <>
      ...
      >
        {user ? (
          <>
            ...
            <Stack.Screen name="CashPoints" component={CashPointsScreen} />
      ...
      <RestaurantChangeOverlayContainer />
    </>
  );
};
