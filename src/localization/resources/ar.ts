...
const ar: TranslationDictionary = {
  ...
  profile: {
    ...
    language: {
      ...
      hints: {
        ...
        ar: 'تخطيط من اليمين إلى اليسار للقراء العرب',
      },
      note: 'يتم تحديث اختيارك فورًا في جميع أنحاء التطبيق. سيؤدي التغيير إلى/من العربية إلى تحديث اتجاه التخطيط.',
    },
    Cash: {
    ...
    notifications: {
      ...
      hero: {
        ...
        description:
          'فعّل الإشعارات لتلافي تفويت تحديثات الطلبات، تنبيهات التوصيل، أو العروض الحصرية. أنت المتحكم — اختر ما يهمك أكثر.',
        ...
        orderingPayments: {
          ...
          questions: {
            ...
            paymentMethods: {
              ...
              answer:
                'نقبل البطاقات الائتمانية/الخصم الرئيسية، محافظ الهاتف المحمول، وبطاقات الهدايا.',
            },
            cancelCharge: {
              question: 'هل سيتم تحصيل رسوم إذا ألغيت طلبي؟',
              answer:
                'لن تتم محاسبتك إذا ألغي الطلب قبل المعالجة. قد تستغرق المبالغ المستردة 3-5 أيام عمل.',
            },
            declinedPayment: {
              question: 'لماذا رُفض دفعي؟',
              answer:
                'قد يحدث هذا بسبب عدم كفاية الأموال في بطاقتك أو رفض البنك للمعاملة لأسباب أمنية.',
            },
          },
        },
        deliveryTiming: {
        ...
        accountSafety: {
          ...
          questions: {
            ...
            deleteAccount: {
              ...
              answer:
                'نعم. اذهب إلى "إعدادات الحساب" → "حذف الحساب والبيانات" لإزالة حسابك نهائيًا.',
            },
          },
        },
      },
    ...
    orderHistory: {
      ...
      states: {
        ...
        emptySubtitle:
          'كل وجبة رائعة تبدأ بنقرة أولى. استكشف المطاعم ذات التقييم العالي وابنِ إرثك النكهي اليوم.',
      },
      actions: {
        retry: 'إعادة المحاولة',
        startOrdering: 'بدء الطلب',
    ...
    deleteAccount: {
      ...
      warningDescription:
        'سيؤدي حذف حسابك إلى إزالة جميع بياناتك نهائيًا، بما في ذلك الأرباح، سجل التوصيل، والمعلومات الشخصية.',
      ...
      successDescription:
        'تم حذف حسابك وجميع البيانات المرتبطة به بنجاح. سيتم تسجيل خروجك تلقائيًا.',
      okay: 'موافق',
    },
    modals: {
      common: {
  ...
  auth: {
    ...
    common: {
      ...
      terms: {
        ...
        description:
          'بتحديد "أوافق" أدناه، أؤكد أنني قرأت ووافقت على <terms> وأقر <privacy>. عمري 18 سنة على الأقل.',
    ...
    email: {
      ...
      signup: {
        ...
        notifications: {
          ...
          description:
            'تُستخدم الإشعارات الفورية لتقديم تحديثات عن طلبك. يمكنك تغيير هذا في الإعدادات في أي وقت.',
  ...
  onboarding: {
    ...
    checkoutAddress: {
      ...
      description: 'تأكد من صحة عنوان التوصيل الخاص بك. يمكنك تغييره بالنقر على الزر أعلاه.',
    },
    checkoutPayment: {
      title: 'اختر طريقة الدفع',
      description: 'حدد كيف تريد الدفع مقابل طلبك - بالبطاقة أو نقدًا عند التوصيل.',
    },
    checkoutPlaceOrder: {
      title: 'قدم طلبك',
      description: 'كل شيء يبدو جيدًا؟ انقر هنا لتأكيد وتقديم طلبك!',
    },
    orderTrackingStatus: {
      title: 'تتبع طلبك',
      description: 'تابع رحلة طلبك من التحضير إلى التوصيل. يمكنك رؤية التحديثات الفورية هنا.',
    },
    orderTrackingDeliveryCode: {
      title: 'رمز التحقق من التوصيل',
      description: 'عندما يصل طلبك، شارك هذا الرمز مع سائق التوصيل لتأكيد الاستلام.',
    },
    profilePoints: {
      title: 'نقاط الولاء الخاصة بك',
      description: 'هنا يمكنك رؤية رصيد نقاطك الحالي. اكسب نقاطًا مع كل طلب واستخدمها للحصول على مكافآت!',
    },
    profileLoyalty: {
      title: 'مكافآت الولاء',
      description: 'انقر هنا لعرض واستبدال مكافآت الولاء الخاصة بك، أو تحويل النقاط، أو التحقق من مزاياك.',
    },
    profileFavorites: {
      title: 'مفضلاتك',
      description: 'الوصول إلى مطاعمك وعناصر القائمة المفضلة هنا للطلب السريع.',
    },
    profileSettings: {
      title: 'إعدادات الملف الشخصي',
      description: 'إدارة إعدادات حسابك والإشعارات وتفضيلات اللغة والمزيد من هنا.',
    },
  },
};
